...
#define OIIO_NAMESPACE_BEGIN namespace OpenImageIO { inline namespace v3_2_0 {
#define OIIO_NAMESPACE_END } }
#define OIIO_NAMESPACE_USING using namespace OIIO;
#define OIIO_CURRENT_NAMESPACE OpenImageIO::v3_2_0
